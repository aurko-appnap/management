...
<table>
    <caption>BRANDS wise order summary</caption>
    <thead>
        <th>Serial</th>
        <th>Order Number</th>
        <th>Order By</th>
...
<div class="pagination">
    ...
    <a class='<?php echo $page==$currentPage ? "active" : "" ?>' href="{{url('/admin/brands/order-detail/'.$brandID.'?p='.$currentPage)}}">{{$currentPage}}</a>
    @endfor
</div>
